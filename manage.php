...
$base_url = "/wp-admin/edit.php?page=mu/mu.php";
?>
<style type="text/css">
fieldset { margin: 10px 0; border:1px solid #CECECE; padding:10px; }
a.mu { text-decoration:none; }
...
{ ?>
		<p>Tip: enter #title# as a placeholder for the post's title in any of the text fields</p>
		<fieldset>
				...
				<td colspan="2">
					...
					<tr>
						...
						<td>
							...
							<small>( use #link# as placeholder for post link )</small>
						</td>
					</tr>
					</table>
					</td>
